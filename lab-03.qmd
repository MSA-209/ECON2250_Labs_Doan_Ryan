...
**To complete these exercise, you have to have at least**

**one contributions from your teammates in your repository.**
...
data("cps", package = "probstats4econ")
...
*Visualization replication 2* \AddToHookNext{env/Highlighting/begin}{\small}p
...
ggplot(datal, aes(x=name, y=count)) +
